...
sudo docker run --detach --name=Users_DB --env="MYSQL_ROOT_PASSWORD=$1" --publish 3306:3306 --update=on-failure --volume=/storage/docker/mysql-data:/var/lib/mysql mysql
